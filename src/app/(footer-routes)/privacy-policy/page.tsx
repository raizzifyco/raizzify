        ...
        <div className="flex items-center justify-center min-h-screen py-14 font-manrope">
            <div className="flex max-w-screen-sm flex-col gap-y-4">
                ...
                <div className="flex flex-col gap-y-10 text-muted-foreground font-light">
                    ...
                    <p>{'This privacy notice for Raizzify Products and Services Private Limited (doing business as Raizzify Business) ("we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:'}</p>
                    <p>{'	Visit our website at http://www.raizzify.com, or any website of ours that links to this privacy notice'}</p>
                    <p>{'	Download and use our mobile application (Raizzify ), or any other application of ours that links to this privacy notice'}</p>
                    <p>{'	Engage with us in other related ways, including any sales, marketing, or events'}</p>
                    <p>{'Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at privacy@raizzify.com.'}</p>
                    ...
                    <p>{'6. DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?'}</p>
                    ...
                    <p>{'Payment Data. We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by Razorpay. You may find their privacy notice link(s) here: https://razorpay.com/privacy/.'}</p>

                    <p>{'Social Media Login Data. We may provide you with the option to register with us using your existing social media account details, like your Facebook, X, or other social media account. If you choose to register in this way, we will collect certain profile information about you from the social media provider, as described in the section called "HOW DO WE HANDLE YOUR SOCIAL LOGINS?" below.'}</p>
                    ...
                    <p>{'	Mobile Device Access. We may request access or permission to certain features from your mobile device, including your mobile devices camera, reminders, geolocation, sms messages, and other features. If you wish to change our access or permissions, you may do so in your device settings.'}</p>
                    ...
                    <p>{'	Push Notifications. We may request to send you push notifications regarding your account or certain features of the application(s). If you wish to opt out from receiving these types of communications, you may turn them off in your devices settings.'}</p>
                    ...
                    <p>{'	When we use Google Maps Platform APIs. We may share your information with certain Google Maps Platform APIs (e.g., Google Maps API, Places API). We use certain Google Maps Platform APIs to retrieve certain information when you make location-specific requests. This includes: Geolocation; __________; and other similar information. A full list of what we use information for can be found in this section and in the previous section titled "HOW DO WE PROCESS YOUR INFORMATION?" We obtain and store on your device ("cache") your location. You may revoke your consent anytime by contacting us at the contact details provided at the end of this document. The Google Maps Platform APIs that we use store and access cookies and other information on your devices. If you are a user currently in the European Economic Area (EU countries, Iceland, Liechtenstein, and Norway) or the United Kingdom, please take a look at our Cookie Notice.'}</p>
                    ...
                    <p>{'pecific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice.'}</p>
                    ...
                    <p>{'In Short: We offer products, features, or tools powered by artificial intelligence, machine learning, or similar technologies.'}</p>
                    ...
                    <p>{'All personal information processed using our AI Products is handled in line with our privacy notice and our agreement with third parties. This ensures high security and safeguards your personal information throughout the process, giving you peace of mind about your data safety.'}</p>
                    ...
                    <p>{'If you have questions or comments about your privacy rights, you may email us at privacy@raizzify.com.'}</p>
                    ...
                    <p>{'If you have questions or comments about this notice, you may email us at privacy@raizzify.com or contact us by post at:'}</p>
