import hero from '../../public/images/owner-hero.png'
import { Button } from "./ui/button"
import marquee1 from '../../public/images/marquee1.png'
import marquee2 from '../../public/images/marquee2.png'
import marquee3 from '../../public/images/marquee3.png'
import marquee4 from '../../public/images/marquee4.png'
import marquee5 from '../../public/images/marquee5.png'
import marquee6 from '../../public/images/marquee6.png'
import marquee7 from '../../public/images/marquee7.png'
import marquee8 from '../../public/images/marquee8.png'
import marquee9 from '../../public/images/marquee9.png'
        ...
        <div className="flex flex-col justify-center items-center py-10">
            ...
            <div className="flex flex-col items-center whitespace-nowrap w-full gap-y-8">
                <div className="font-bold lg:text-[56px] sm:text-[38px] xs:text-[30px] text-[26px] md:px-0 px-6 md:w-3/4 w-full text-center md:leading-relaxed">
                    <h1 className="text-center">The all-in-one platform</h1>
                    <p className="text-center sm:block flex items-center flex-col">
                        purpose-built for
                ...
                <div className="sm:flex hidden items-center gap-x-6">
                    <Button variant={'default'} className="w-[200px] py-6 font-semibold">
                        Get Started
                    </Button>
            ...
            <div className="mt-10 relative w-full">
                            ...
                            {firstMarq.map((item, i) => (
                                <div key={i} className="bg-white p-4 border border-[#00A210] rounded-md shadow-md">
                                    <div className="relative w-20 h-20">
                                        <Image src={item.imageUrl} layout="fill" objectFit="contain" alt="" />
                                    </div>
                ...
                <div className="sm:hidden flex flex-col items-center gap-y-6 mt-6">
                    <Button variant={'default'} className="sm:w-[200px] w-[300px] py-6">
                        Get Started
                    </Button>
