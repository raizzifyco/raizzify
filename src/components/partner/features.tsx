...
const Features = () => {
  return (
    <div className="relative">
      <div className="sticky top-0 h-screen flex flex-col md:flex-row justify-between items-center bg-gradient-to-r from-[#FCFDF8] to-[#59e5ce] pl-6 pb-10">
      ...
      <div className="sticky top-0 h-screen flex flex-col md:flex-row justify-between items-center  md:py-2 py-20 md:pl-20 pl-0 md:pr-10 pr-0 bg-gradient-to-br from-[#FFCD3B] to-[#FCFDF8]">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left gap-4 px-10 md:pl-20 md:w-1/2">
          <div>
            ...
            <p className="text-base md:text-lg mt-2">
              Will you enjoy a free haircut or a car wash after your next
              purchase? That’s the feeling your customers will get — coupons
              based on their bill, redeemable across top businesses, including
              your own for repeat visits.
            </p>
          </div>
        </div>
      </div>

      <div className="sticky top-0  flex flex-col md:flex-row-reverse justify-between items-center h-auto md:h-screen md:py-2 py-10 md:px-20 px-6 bg-gradient-to-br from-[#e4e4e3] to-[#eb9e81]">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left gap-2">
          ...
          <p className="text-base md:text-lg mt-2">
            Bigger bills mean better rewards! Customers unlock more coupons and
            perks at salons, cafes, cinemas, and more.
          </p>
        </div>
      </div>
    </div>
