    ...
    return (
        <div className="flex hero flex-col justify-center items-center py-10 px-4">
            ...
            <div className="mt-10 relative w-full">
                <h1 className="absolute text-primary left-1/2 md:top-1/2 sm:top-[10%] top-[8%] -translate-x-1/2 -translate-y-1/2 lg:text-[220px] md:text-[160px] sm:text-[120px] xs:text-[88px] text-[70px] font-bold">RAIZZIFY</h1>
            ...
            <div className="flex flex-col items-center text-center text-muted-foreground mt-10">
                <p className="md:block hidden">Login to Raizzify | Select Services on your favourite Salon | Book Your Appointment </p>
